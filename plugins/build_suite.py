#!/usr/bin/env python3
"""
build_suite.py — 同步 repo 頂層 skills/ 複本進 plugins/ai-sdlc-suite/skills/(建置產物)

單一真相在 skills/;plugin 內複本只由本腳本產生(冪等)。
用法:
...
SRC = ROOT / "skills"
DST = ROOT / "plugins" / "ai-sdlc-suite" / "skills"
SKILLS = ("ai-sdlc", "ai-sdlc-autopilot")
