...
| ✦ CI/CD [`ci-cd`](skills/ai-sdlc/references/ci-cd.md)(**選用**) | pre-commit 初步檢查 + pipeline 權威門檻 |

> 抗 session 壓縮:含「Session 啟動檢查 + 不倚賴記憶以文件為準」。跨專案:Guideline/CHG/ACC/結構文件標頭都有「專案」欄。
